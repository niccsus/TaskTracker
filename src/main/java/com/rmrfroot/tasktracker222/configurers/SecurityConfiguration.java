...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                .antMatchers("/login", "/new-user-registration", "/register-new-user",  "/registration/**", "/static/**", "/pending-approval","/PendingApproval/","/drill-schedule-recipient").permitAll() // Add "/static/**" for static resources
                .antMatchers("/**")
                .authenticated()
                .and()
                .formLogin()
